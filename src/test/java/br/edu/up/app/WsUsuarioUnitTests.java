...
public class WsUsuarioUnitTests {
	...
	private static String USUARIOS_ENDPOINT = "http://localhost:3000/usuario";
	...
	public void atualizarUsuarioTest() {
		...
		ResponseEntity<Usuario> response = rest.exchange(USUARIOS_ENDPOINT, HttpMethod.POST, requestCreate,
				Usuario.class);
